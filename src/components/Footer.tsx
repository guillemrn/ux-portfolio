...
export const Footer: React.FC = () => {
    return (
        <footer className="w-full bg-brand-dark text-white pt-40 pb-12 px-6 md:px-12 flex flex-col justify-end min-h-[85vh] relative" id="contact">
            ...
            <div className="mt-24 border-t border-white/10 pt-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-12 font-sans text-sm tracking-[0.2em] uppercase font-bold">
